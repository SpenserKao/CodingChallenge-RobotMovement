package codechallenge.robototmovement;
...
public class RobotTest extends TestCase {
    ...
    @Before
    public void setUp() {
        robot = new Robot(new Tabletop ("ioof_robot.properties"));
    }
