...
### Unit test
   Usage: _Java -cp &lt;class search path of directories and zip/jar files&gt; &lt;Unit test class &gt;_<br/>
	...
	Without IDE, such as Eclipse or NetBeans, or building automation tool, such as Maven or Gradle, The simplest of conducting unit test is going through commands line, as examples shown follows:
	<pre>
